...
public final class PositiveSize
  ...
  * */
  ...
  /**
   * Create PositiveSize from simple arguments Only the monoOf.. factory methods is allowed, because
  ...
  /**
   * Create PositiveSize from Mono with Tuple inside The method helps chaining flows together
   *
  ...
  /**
   * pattern matching in vavr The method helps with conversion operations PositiveSize-&gt;Tuple
   * <p>
   * - you need add static import to method with pattern matching import static
   * life.expert.riso.common.PositiveSizePatterns.*;
   *
  ...
  /**
   * Create PositiveSize from Tuple The method helps with conversion operations
   * Tuple-&gt;PositiveSize
   *
   * @param tuple the tuple
   * @return the Mono with lazyli created object
