...
public class ShellCommandsTest
  ...
  public void newFirstLineTest() {
    ...
    assertThat(commandTarget.getHelp(),
        is("Create a new line from (x1,y1) to (x2,y2). Currently only\n horizontal or vertical lines are supported. Horizontal and vertical lines\n will be drawn using the 'x' character."));
    assertThat(commandTarget.getMethod(),
        is(findMethod(COMMAND_CLASS_UNDER_TEST, commandMethod, int.class, int.class, int.class,
            int.class)));
    assertThat(commandTarget.getAvailability()
        .isAvailable(), is(true));
  ...
  public void newRectangleTest() {
    ...
    assertThat(commandTarget.getGroup(), is("Drawing Commands"));
    assertThat(commandTarget.getHelp(),
        is("Create a new rectangle, whose upper left corner is (x1,y1) and\n lower right corner is (x2,y2). Horizontal and vertical lines will be drawn\n using the 'x' character."));
    assertThat(commandTarget.getMethod(),
        is(findMethod(COMMAND_CLASS_UNDER_TEST, commandMethod, int.class, int.class, int.class,
            int.class)));
    assertThat(commandTarget.getAvailability()
  ...
  public void fillAreaTest() {
    ...
    assertThat(commandTarget.getGroup(), is("Drawing Commands"));
    assertThat(commandTarget.getHelp(),
        is("Fill the entire area connected to (x,y) with \"colour\" c. The\n behavior of this is the same as that of the \"bucket fill\" tool in paint\n programs."));
    assertThat(commandTarget.getMethod(),
        is(findMethod(COMMAND_CLASS_UNDER_TEST, commandMethod, int.class, int.class,
            String.class)));
    assertThat(commandTarget.getAvailability()
